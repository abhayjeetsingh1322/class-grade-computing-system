...
void resetScoreOfCat3Grade (Node *nodePtr, int scoreCat, float newScore)
{
    //Updating score based on score category and new score
    switch(scoreCat) 
    {
        case 1: 
            nodePtr->Student.Cat3.score1 = newScore;
            break;
        case 2:
            nodePtr->Student.Cat3.score2 = newScore;
            break;
        case 3: 
            nodePtr->Student.Cat3.score3 = newScore;
            break;
        default:
